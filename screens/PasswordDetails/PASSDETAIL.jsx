  ...
  return (
    <SafeAreaView style={[styles.container,{backgroundColor: THEME.BGCOLOR}]}>
      ...
      <ScrollView
        ...
        <Animated.View
        style={[styles.ItemContainer,{backgroundColor: THEME.SECOUNDARY2}]}>
          ...
          style={[styles.passwordContainer]}>
            ...
            <View style={[styles.eachItemcontentView]}>
              ...
              <Text style={[styles.eachItemText]}>{Details.password}</Text>
            </View>
          ...
          <View style={[styles.DetailsContainer]}>
            <Text style={[styles.detailHeaing,{color: isDarkMode ? '#5be264c4' : 'green'}]}>Details</Text>

            <View>
              <Text style={[styles.placeHolder]}>Website address/App name</Text>
